...
public class TestDiceRollDialog extends JDialog {
    ...
    /**
     * Constructs a modal dialog to input a custom dice roll amount.
     * 
    ...
    public TestDiceRollDialog(Frame parent) {
        ...
        btnCancel.addActionListener(new ActionListener() {
            ...
            /**
             * Handles the OK button action by parsing the input amount, setting the dice
             * roll accordingly, and hiding the dialog.
             * 
             * @param e the action event triggered by clicking the OK button
             */
    ...
    /**
     * Returns the current dice roll values set by the dialog.
     * 
     * @return an array of two integers representing the dice roll
     */
